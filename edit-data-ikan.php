                ...
                <!-- Begin Page Content -->
                 <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-4 text-gray-800">From Edit Data Ikan </h1>
                        ...
                        <?php 
                            $id=$_GET['id'];
                            $query_edit=mysqli_query($koneksi, "SELECT * FROM stk_ikn WHERE id_ikan='$id'");
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control"  name="id" value="<?php echo $row['id_ikan'] ?>">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="nama_ikan" name="nama_ikan" value="<?php echo $row['nama_ikan']; ?>">
                            </div>
                        </div>
                        <div class="row mb-3">
