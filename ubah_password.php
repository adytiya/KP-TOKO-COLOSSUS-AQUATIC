...
<body class="bg-gradient-primary">
    ...
    <div class="container">
                                ...
                                <div class="p-5 ">
                                    <div class="p-1">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-5">Password Anda</h1>
                                        </div>
                                        <form method="get" action="proses_ubah_pass.php">

                                            <?php
                                            require "koneksi.php";
                                            $user = $_GET['username'];
                                            $query_edit = mysqli_query($koneksi, "SELECT * FROM user WHERE username='$user'");
                                            ...
                                            ?>
                                                ...
                                                <a href="lupa_password.php" class="btn btn-primary">
                                                    Kembali
                                                </a>
        ...
        <script>
            $.backstretch("img/Green-Branch-Background_1024.jpg", {
                speed: 500
            });
        </script>
</body>
